                ...
                <div className="flex-1 bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
                  ...
                  {[
                    ...
                    },
                    {
                      ...
                      label: "Gender", value: null, badge: "notadded", add: true
                    },
                    {
                      ...
                      label: "Date of Birth", value: null, badge: "notadded", add: true
                    },
                  ].map((row, i) => (
                    <div key={i} className="flex items-center py-4 border-b border-gray-100 last:border-0">
                      ...
                      {row.badge === "notadded" && (
                        <span className="text-xs font-medium px-3 py-1 rounded-md mr-4" style={{ backgroundColor: "#fef3c7", color: "#d97706" }}>
                          Not Added
                        </span>
                      )}
                      {row.badge === "added" && (
                      ...
                      {row.add && (
                        <button className="text-sm font-medium flex items-center gap-1" style={{ color: "#2563eb" }}>
                          + Add
                        </button>
                      )}
                    </div>
